									...
									<div class="header-row">
										<nav class="header-nav-top">
											<ul class="nav nav-pills">
												<li class="nav-item">
													<span class="ws-nowrap custom-text-color-grey-1 text-2 ps-0"><i class="icon-envelope icons text-4 top-3 left-1 me-1"></i> <a href="https://www.okler.net/cdn-cgi/l/email-protection#02677a636f726e6742666d6f636b6c2c616d6f" class="text-color-default text-color-hover-primary"><span class="__cf_email__" data-cfemail="aacfd2cbc7dac6cfeacec5c7cbc3c484c9c5c7">[email&#160;protected]</span></a></span>
												</li>
						...
						<div class="row py-5 mb-5 mt-2 p-relative z-index-1">
							<div class="col">
								...
								<div class="overflow-hidden mb-4">
									<h1 class="d-block text-color-quaternary font-weight-bold line-height-3 text-center mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1000">An Interview with John Doe</h1>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row py-5">
						...
						<div class="col-lg-3">
							...
							<ul class="list list-unstyled">
								...
								<li class="mb-1">
									Email: <a href="#"><span class="__cf_email__" data-cfemail="2b464a42476b4e534a465b474e05484446">[email&#160;protected]</span></a>
								</li>
							</ul>
