					...
					<div class="header-column justify-content-end">
						<div class="header-row">
							...
							<?php if (isset($_SESSION['full_name'])) { ?>
								<a href="mailto:<?= $_SESSION['staff_email'] ?>" class="btn btn-tertiary font-weight-semibold text-3 px-4 custom-height-1 rounded-0 align-items-center d-none d-md-flex">
